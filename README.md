...
3. Raft实现包括4个模块[Part2A: leader election](#Part2A)、[Part2B: log](#Part2B: log)、[Part2C: persistence](#Part2C: persistence)、[Part2D: log compaction(optional)](#Part2D: log compaction(optional))，最后这个是可选的任务
